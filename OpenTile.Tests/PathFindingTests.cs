...
namespace OpenTile.Tests
{
    ...
    public class PathFindingTests
    {
        ...
        public void Test_WithMazeWall()
        {
            ...
            // long path
            InitializeMap(7, 5, new Vector3(0, 0, 4), new Vector3(6, 0, 4));
            this.map[0, 0] = "W";
            this.map[1, 4] = "W";
            this.map[1, 3] = "W";
            this.map[1, 2] = "W";
        ...
        public void Test_Contained_RangeOf1_StartIsSameAsFinish()
        {
            // Arrange
            Vector3 startingLocation = new Vector3(2, 0, 2);
            Vector3 endingLocation = new Vector3(2, 0, 2);
            int height = 5;
            int width = 5;
            InitializeMap(width, height, startingLocation, endingLocation, false);
            PathFinding pathFinder = new PathFinding(searchParameters);
        ...
        private void InitializeMap(int xMax, int zMax, Vector3 startingLocation, Vector3 endLocation, bool locationsNotSet = true)
        {
            //  □ □ □ □ □ □ □
            //  □ □ □ □ □ □ □
            //  □ S □ □ □ F □
        ...
        private void CreateDebugPictureOfMapAndRoute(int xMax, int zMax, List<Vector3> path)
        {
            ...
            foreach (Vector3 item in path)
            {
                ...
                if (i == path.Count - 1)
                {
                    mapDebug[int.Parse(item.x.ToString()), int.Parse(item.z.ToString())] = " F";
                }
                else
                {
                    mapDebug[int.Parse(item.x.ToString()), int.Parse(item.z.ToString())] = " *";
                }
                i++;
            }
